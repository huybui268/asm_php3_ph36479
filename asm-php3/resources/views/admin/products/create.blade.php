                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-xl-6 col-lg-6">
                                ...
                                <input type="number" class="form-control" id="price_sale" placeholder="Nhập giá giảm..." name="price_sale" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="mb-3 col-xl-6 col-lg-6">
                            ...
                            <div class="mb-3 col-xl-6 col-lg-6">
                                ...
                                <input type="text" class="form-control" id="color" placeholder="Nhập tên màu..." name="color" required>
                            </div>
                        </div>
                        <div class="mb-3">
